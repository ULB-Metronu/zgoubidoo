...
class CGTR:
    ...
    def __init__(self,
        ...
        self.zi: _Input = _Input('CGTR', line=[
            ...
            self.b2g,
            _Chamber(IA=2),
            _FakeDrift(XL=31.7710542750315 * _ureg.cm - self.b2g.extra_drift),
            self.smx,
            _FakeDrift(XL=13.04307815686367 * _ureg.cm),
            self.smy,
            _FakeDrift(XL=20.38583539698301 * _ureg.cm - self.b3g.extra_drift),
