...
class DipoleIBA(_Dipole):
    ...
    def extra_drift(self) -> _ureg.Quantity:
        ...
        Returns:
            the drift lenght.
        """
        return _PolarMagnet.drift_length_from_polar(
            radius=self.radius,
...
class B1G(DipoleIBA):
    ...
    Examples:
        >>> B1G() #doctest: +NORMALIZE_WHITESPACE
        <BLANKLINE>
        <BLANKLINE>
        'DIPOLE' B1G
        0
        5.00000000000000000000e+01 1.500000000000e+02
        2.50000000000000000000e+01 1.400000000000e+01 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        9.000000000000e+00 -1.0
        6 0.000000000000e+00 1.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        2.00000000000000000000e+01 0.000000000000e+00 1.000000000000e+09 -1.000000000000e+09 1.000000000000e+09 1.000000000000e+09
        9.000000000000e+00 -1.0
        6 0.000000000000e+00 1.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        -2.00000000000000000000e+01 0.000000000000e+00 1.000000000000e+09 -1.000000000000e+09 1.000000000000e+09 1.000000000000e+09
        0.000000000000e+00 0
        6 0.000000000000e+00 1.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        0.000000000000e+00 0.000000000000e+00 1.000000000000e+09 1.000000000000e+09 1.000000000000e+09 1.000000000000e+09 1.000000000000e+09
        2 1.000000000000e+01
        0.1
        2
        1.505729756315e+02 -8.726646259972e-02 1.505729756315e+02 8.726646259972e-02
    """
    ...
    def post_init(
        ...
        **kwargs,
        ...
        Example:
            >>> b1g = B1G()
            >>> b1g.fit(kinematics=zgoubidoo.Kinematics(230*_ureg.MeV)) #doctest: +NORMALIZE_WHITESPACE
            <BLANKLINE>
            <BLANKLINE>
            'DIPOLE' B1G
            0
        ...
        self.RS = _PolarMagnet.efb_offset_from_polar(
            radius=self.RM,
            magnet_angle=magnet_opening,
            poles_angle=poles_opening,
        )
        self.TE = _PolarMagnet.efb_angle_from_polar(
            magnet_angle=magnet_opening,
            poles_angle=poles_opening,
        )
        self.TS = -_PolarMagnet.efb_angle_from_polar(
            magnet_angle=magnet_opening,
            poles_angle=poles_opening,
        )
...
class B2G(DipoleIBA):
    ...
    Examples:
        >>> B2G() #doctest: +NORMALIZE_WHITESPACE
        <BLANKLINE>
        <BLANKLINE>
        'DIPOLE' B2G
        0
        8.00000000000000000000e+01 1.500000000000e+02
        4.00000000000000000000e+01 1.400000000000e+01 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        9.000000000000e+00 -1.0
        6 0.000000000000e+00 1.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        3.50000000000000000000e+01 0.000000000000e+00 1.000000000000e+09 -1.000000000000e+09 1.000000000000e+09 1.000000000000e+09
        9.000000000000e+00 -1.0
        6 0.000000000000e+00 1.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        -3.50000000000000000000e+01 0.000000000000e+00 1.000000000000e+09 -1.000000000000e+09 1.000000000000e+09 1.000000000000e+09
        0.000000000000e+00 0
    ...
    def post_init(
        ...
        **kwargs,
        ...
        Example:
            >>> b2g = B2G()
            >>> b2g.fit(kinematics=zgoubidoo.Kinematics(230*_ureg.MeV)) #doctest: +NORMALIZE_WHITESPACE
            <BLANKLINE>
            <BLANKLINE>
            'DIPOLE' B2G
            0
...
class B3G(DipoleIBA):
    ...
    Examples:
        >>> B3G() #doctest: +NORMALIZE_WHITESPACE
        <BLANKLINE>
        <BLANKLINE>
        'DIPOLE' B3G
        0
        7.00000000000000000000e+01 1.600000000000e+02
        3.50000000000000000000e+01 1.400000000000e+01 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        9.000000000000e+00 -1.0
        6 6.763405400000e-01 1.157768410000e+00 -1.693798600000e-01 7.696388000000e-02 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        2.88750000000000000000e+01 0.000000000000e+00 1.000000000000e+09 -1.000000000000e+09 1.000000000000e+09 1.000000000000e+09
        9.000000000000e+00 -1.0
        6 7.789082000000e-01 9.449054500000e-01 -1.303478700000e-01 2.948957000000e-02 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        -2.88750000000000000000e+01 0.000000000000e+00 1.000000000000e+09 -1.000000000000e+09 1.000000000000e+09 1.000000000000e+09
        0.000000000000e+00 0
        6 0.000000000000e+00 1.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
        0.000000000000e+00 0.000000000000e+00 1.000000000000e+09 1.000000000000e+09 1.000000000000e+09 1.000000000000e+09 1.000000000000e+09
        ...
        0.1
        2
        1.606111740069e+02 -8.726646259972e-02 1.606111740069e+02 8.726646259972e-02
    """
    ...
    def post_init(
        ...
        **kwargs,
        ...
        Example:
            >>> b3g = B3G()
            >>> b3g.fit(kinematics=zgoubidoo.Kinematics(230*_ureg.MeV)) #doctest: +NORMALIZE_WHITESPACE
            <BLANKLINE>
            <BLANKLINE>
            'DIPOLE' B3G
            0
...
class CGTR:
    ...
    def spots(
        ...
        z = _Zgoubi()
        fits = [self.shoot(x=float(spot[0]), y=float(spot[1]), zgoubi=z, fit_type=fit_type) for spot in spots]
        z.cleanup()
        if debug_fit:
            return fits
