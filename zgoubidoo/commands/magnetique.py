...
class CartesianMagnet(Magnet, metaclass=CartesianMagnetType):
    ...
    def entry_integration(self) -> Optional[_Frame]:
        ...
        if self._entry_integration is None:
            ...
            self._entry_integration.translate_x(-self.entrance_face_integration)
...
class PolarMagnet(Magnet, metaclass=PolarMagnetType):
    ...
    def exit_integration(self) -> Optional[_Frame]:
        if self._exit_integration is None:
            self._exit_integration = self.exit_patched.__class__(self.exit_patched)
        return self._exit_integration
...
class Dipole(PolarMagnet):
    ...
    >>> m = Dipole(LABEL1="D1", AT=10*_ureg.degrees, RM = 1*_ureg.m, B0=1*_ureg.kilogauss)
    >>> m.fit(zgoubidoo.Kinematics(10*_ureg.MeV)) # doctest: +NORMALIZE_WHITESPACE
    <BLANKLINE>
    <BLANKLINE>
            'DIPOLE' D1
            0
            1.00000000000000000000e+01 1.000000000000e+02
            5.00000000000000000000e+00 1.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
            0.000000000000e+00 -1.0
            ...
            5.00000000000000000000e+00 0.000000000000e+00 1.000000000000e+09 -1.000000000000e+09 1.000000000000e+09 1.000000000000e+09
            0.000000000000e+00 -1.0
            6 0.000000000000e+00 1.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00 0.000000000000e+00
            -5.00000000000000000000e+00 0.000000000000e+00 1.000000000000e+09 -1.000000000000e+09 1.000000000000e+09 1.000000000000e+09
            ...
            0.1
            2
            1.000000000000e+02 0.000000000000e+00 1.000000000000e+02 0.000000000000e+00
    """
    KEYWORD = "DIPOLE"
    """Keyword of the command used for the Zgoubi input data."""
...
class Drift(CartesianMagnet):
    ...
    >>> Drift(LABEL1='D1', XL=10 * _ureg.cm) # doctest: +ELLIPSIS, +NORMALIZE_WHITESPACE
    <BLANKLINE>
    <BLANKLINE>
            'DRIFT' D1
            1.000000000000e+01 split 10 0
    <BLANKLINE>
...
class PS170(Magnet):
    ...
    Examples:
        >>> PS170('PS170', IL=2, XL=2 * _ureg.m, R0 = 1.5 * _ureg.m, B0 = 1 * _ureg.tesla) #doctest: +NORMALIZE_WHITESPACE
        <BLANKLINE>
        <BLANKLINE>
            'PS170' PS170
            2
            2.000000000000e+02 1.500000000000e+02 1.000000000000e+01
            1.000000000000e-01
