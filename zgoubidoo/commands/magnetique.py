...
class FFAG(PolarMagnet):
    ...
    PARAMETERS = {
        ...
        'KIRD': (2, 'Analytical computation (KIRD = 0) or numerical interpolation (KIRD = 2,4, 25) of field derivatives', 161),
        'RESOL': (2, '', 162),
        'XPAS': (1.0 * _ureg.millimeter, 'Integration step', 163),
        'KPOS': (2, '', 164),
        'RE': (0.0 * _ureg.centimeter, '', 165),
        'TE': (0.0 * _ureg.radian, '', 166),
        'RS': (0.0 * _ureg.centimeter, '', 167),
        'TS': (0.0 * _ureg.radian, '', 168),
        'DP': (0.0, '', 169),
        'COLOR': '#4169E1',
    }
    """Parameters of the command, with their default value, their description and optinally an index used by other 
