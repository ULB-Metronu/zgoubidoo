...
class MCObjet(_Command, metaclass=_ObjetType):
    ...
    PARAMETERS = {
        ...
        'KY': (1, '1 - Uniform, 2 - Gaussian, 3 - Parabolic'),
        'KT': (1, '1 - Uniform, 2 - Gaussian, 3 - Parabolic'),
        'KZ': (1, '1 - Uniform, 2 - Gaussian, 3 - Parabolic'),
        'KP': (1, '1 - Uniform, 2 - Gaussian, 3 - Parabolic'),
        'KX': (1, '1 - Uniform, 2 - Gaussian, 3 - Parabolic'),
